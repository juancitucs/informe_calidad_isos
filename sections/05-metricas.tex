...
La guía de trabajo práctico exige proponer métricas cuantitativas para la norma ISO/IEC asignada, con sus ecuaciones \cite{iso33000-committee}. Las métricas definidas evalúan los controles 8.25, 8.28 y 8.29 de ISO/IEC 27001:2022.
...
\begin{equation}
D_v = \frac{4}{10} = 0.4 \text{ vuln/KLOC} \quad \Rightarrow \quad \text{Nivel: Bajo}
\end{equation}
...
Mide el nivel de madurez del proceso de seguridad en el ciclo de vida del desarrollo, basado en la escala de ISO/IEC 33000 \cite{iso33000-committee}:
...
\hline
\end{tabular}
\caption{Resumen de métricas de calidad para los controles 8.25, 8.28 y 8.29}
