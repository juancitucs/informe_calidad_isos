...
La guía de trabajo práctico exige proponer un set de métricas cuantitativas pertinentes para la norma ISO/IEC asignada, detallando sus respectivas ecuaciones matemáticas de obtención \cite{iso33000}. A continuación se presentan las métricas definidas para evaluar el cumplimiento de los controles 8.25, 8.28 y 8.29 de ISO/IEC 27001:2022.
